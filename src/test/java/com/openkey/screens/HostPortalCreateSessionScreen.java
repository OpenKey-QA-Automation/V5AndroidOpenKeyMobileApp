...
public class HostPortalCreateSessionScreen extends BaseScreen {
        ...
        By roomIdDropdown = By.xpath("//span[@class='mat-option-text'][contains(.,'101')]"); //Programmatically change
    ...
    public void createNewSession() throws InterruptedException {
            ...
            allureReportingManager.stepsScreenshots();
            //Thread.sleep(3000);
            wait.until(ExpectedConditions.elementToBeClickable(roomId)).sendKeys("101");//Programmatically change
           // wait.until(ExpectedConditions.visibilityOfElementLocated(roomId)).sendKeys("101");//Programmatically change
            Thread.sleep(3000);
